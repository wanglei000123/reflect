...
public class Main {
	...
	public static void Demo5() throws IllegalArgumentException, IllegalAccessException, SecurityException, NoSuchFieldException, InstantiationException, ClassNotFoundException
	{
		...
		Field personNameField2 = class1.getDeclaredField("age");
		personNameField2.setAccessible(true);
		personNameField2.set(obj, 50);
		
		System.out.println("Demo5: 修改属性之后得到属性变量的值：" + personNameField.get(obj) + ":" + personNameField2.get(obj));
	...
	public static void Demo6() throws ClassNotFoundException
	{
		...
		System.out.println("Demo6:  SuperMan类的父类名: " + class1.getSuperclass() + ":" +superClass.getName());
	...
	public static void Demo8() throws ClassNotFoundException
	{
		...
		System.out.println("Demo8: 类加载器类名: " + class1.getClassLoader().getClass());
	}
